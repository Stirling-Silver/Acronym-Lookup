...
function btnClicked() {
  ...
  if (name === "RSVP") {
    ...
    document.getElementById("Acronym").innerHTML = "Conpletely Automated Public Turing test to tell Computers and Humans Apart";
	} else if (name === "CD-ROM") {
    ...
    document.getElementById("Acronym").innerHTML = "Very Important Person / Very Important People";
  } else {
    document.getElementById("Acronym").innerHTML = "??????";
  }
